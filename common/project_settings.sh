...
PROJECT_NAME="playground-s-11-f60a6d"
...
# Must be unique
PUBLIC_ASSETS="playground-s-11-f60a6d-public-bucket"

# This is the Storage bucket used for private assets. 
# The entire bucket is private by default
# Must be unique
PRIVATE_ASSETS="playground-s-11-f60a6d-private-bucket"

# The name of the Pubsub topic to create / use
PUB_SUB_TOPIC="playground-s-11-f60a6d-items"

# The name of the custom network for the product and ads services
SERVICES_NETWORK="playground-s-11-f60a6d-app-network"

# The name of the product service subnet
PRODUCT_SUBNET="playground-s-11-f60a6d-prod-app-network-subnet"

# The name of the product service subnet
ADS_SUBNET="playground-s-11-f60a6d-ad-app-network-subnet"

# The name of the Kubernetes cluster used for the products service
PRODUCT_CLUSTER_NAME="playground-s-11-f60a6d-app-clusters"

# The name of the spanner instance
PRODUCT_DB_INSTANCE_NAME="playground-s-11-f60a6d-app-spanner-instance"

# The name of the spanner db
PRODUCT_DB_NAME="playground-s-11-f60a6d-app-spanner-db"
...
FUNCTION_NAME="playground-s-11-f60a6d-upload"
